<?php include_once "operations/loginOperation.php";?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container">
    <form class="signInForm form-submit" method="post">
        <p class="error-from-backend">
            <?php if (isset($errorMsg)) {echo $errorMsg;} ?>
        </p>
        <div class="form-outline mb-4">
            <input type="text" id="username" class="form-control -bs" value="<?php if (isset($username)){echo $username;} ?>" name="log_username" autocomplete="off" minlength="3" maxlength="15" required/>
